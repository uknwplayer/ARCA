...
| M5-N1 Descoberta PNCP de itens | sim, hash-bound + cost policy + custody-before-observation | sim | run 36051395397: 2 GETs, 200/200, zero retries, STORED_PRIVATE | não | runtime BARE_ARRAY com 4/5 elementos; envelope `41110be7...3d4b`; parser offline aceita array observado | CI/merge → observação offline da custódia → contar `temResultado` → decidir M5-N2 |
