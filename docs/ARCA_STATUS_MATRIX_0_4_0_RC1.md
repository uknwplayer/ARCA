...
| M5-E Binding do preflight ao probe live | sim | sim | não | não | PR #173; CI #356/#357; scope + preflight + fingerprint vinculados antes do transporte | prova operacional Gate 040; depois autorização separada para um GET |
| Gate 040 Preflight Portal isolado | sim | sim | não, por desenho sem GET Portal | não | PR #168; CI #348/#349; workflow sem transporte Portal | executar com secrets reais e revisar hashes sanitizados |
...
| Portal da Transparência / captura M4b | sim, fixture + transporte + preview + custódia HTTP V0.3 + M5-D + Gate 040 + M5-E | sim | parcial: 3 GETs 401; nenhum 2xx | não | PR #88/#95/#99/#102/#105/#107/#165 | obter token pelo fluxo oficial, preflight, autorização específica e primeiro 2xx custodial |
