...
| M5-J PNCP live structure + parser | sim, fixture sintética + estrutura live | sim, observador e parser | estrutura live observada; parser ainda não aplicado aos bytes live | não | run 35932200063; 2 contratações; `observedStructureSha256=4a00de8f...fabb9`; `supplierObserved=false` | admitir e normalizar custódia histórica PNCP |
