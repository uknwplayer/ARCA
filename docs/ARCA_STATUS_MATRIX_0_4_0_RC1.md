...
| Correlação PNCP ↔ execução financeira M2/M5-A…M5-J | sim, contratos/gates + Portal e PNCP live normalizados | sim | parcial: duas fontes live normalizadas e custodiais; correlação ainda não executada | não | Portal M5-I + PNCP M5-J; PNCP run 36026221085, 2 registros | gate offline de prontidão das pontes documentais antes da correlação |
