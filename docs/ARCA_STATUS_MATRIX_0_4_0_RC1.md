...
| Correlação PNCP ↔ execução financeira M2/M5-A/M5-B | sim, M2 sintético + M5 pré-correlação + pós-custódia | sim | não | não | PR #79/#94/#155; CI M5-B 35850287815 e pós-merge 35850394372; custody-bound correlation → 2 agentes → adversarial → HUMAN_REVIEW | primeiro 2xx Portal custodial, schema real observado, parser revisado e duas entradas live normalizadas |
