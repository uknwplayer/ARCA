...
| Correlação PNCP ↔ execução financeira M2/M5-A/M5-B/M5-C | sim, M2 sintético + M5 pré-correlação + pós-custódia + observação de schema | sim | não | não | PR #79/#94/#155/#162; M5-C CI 35855501213 e pós-merge 35855589032 | primeiro 2xx Portal custodial, observação live, parser revisado e duas entradas live normalizadas |
