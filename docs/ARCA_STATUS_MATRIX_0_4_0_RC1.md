...
| M5-M Cobertura PNCP contratos/empenhos | sim, plano privado hash-bound | sim | sim: run 36036733351, 2 GETs, 400/400, zero retries, respostas custodiais | não | envelope `722c2e85...240a`; `STORED_PRIVATE`; sem publicação/correlação | diagnóstico offline dos dois 400; novo GET só com novo candidato/autorização |
