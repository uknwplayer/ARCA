...
| M5-E Binding do preflight ao probe live | sim | sim | parcial: binding validado em preflight real, 0 GET | não | PR #173; CI #356/#357; Gate 040 run 35884318441; scope + preflight + fingerprint vinculados antes do transporte | autorização humana separada para exatamente um GET; depois primeiro 2xx custodial |
...
| Portal da Transparência / captura M4b | sim, fixture + transporte + preview + custódia HTTP V0.3 + M5-D + Gate 040 + M5-E | sim | parcial: 3 GETs 401 + Gate 040 operacional sem GET; nenhum 2xx | não | PR #88/#95/#99/#102/#105/#107/#165; Gate 040 run 35884318441 | autorização específica do quarto GET e primeiro 2xx custodial |
