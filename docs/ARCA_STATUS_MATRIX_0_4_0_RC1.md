...
| Correlação PNCP ↔ execução financeira M2/M5-A/M5-B/M5-C/M5-D | sim, M2 sintético + M5 pré-correlação + pós-custódia + observação de schema | sim | não | não | PR #79/#94/#155/#162; M5-C CI 35855501213 e pós-merge 35855589032 | primeiro 2xx Portal custodial, observação live, parser revisado e duas entradas live normalizadas |
...
| M5-E Binding do preflight ao probe live | candidato offline | em teste | não | não | issue #172; preflight/scope/fingerprint vinculados | CI + integração; depois prova operacional Gate 040 |
| M5-D Prontidão da credencial Portal | sim | sim | não | não | PR #165; CI #343/#344; fingerprint + proveniência + ACTIVE_UNKNOWN | token oficial submetido a probe explicitamente autorizado e primeiro 2xx observado |
| Portal da Transparência / captura M4b | sim, fixture + transporte + preview + custódia HTTP V0.3 + gate de credencial M5-D | sim | parcial: 3 GETs 401; nenhum 2xx | não | PR #88/#95/#99/#102/#105/#107/#165 | obter token pelo fluxo oficial, preflight, autorização específica e primeiro 2xx custodial |
