...
| M5-N1 Descoberta PNCP de itens | sim, plano privado hash-bound | sim, testes + preflight real | preflight 36044350610; nenhum GET live | não | candidato `13816eb8...d844`; 2 alvos; `pagina=1&tamanhoPagina=50`; zero retries | autorização explícita dos 2 GETs → custódia → avaliar truncamento/M5-N2 |
