...
| M5-G Admissão da normalização custodial | sim, gate candidato | sim, sintético | não abre bytes live | não | parser/schema/custódia/scope bound; decisão humana obrigatória | gerar candidato final e obter decisão explícita por `candidateSha256` |
