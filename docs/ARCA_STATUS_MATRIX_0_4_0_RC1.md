...
Data de corte: 2026-09-23. Referência Vince V5 Termux A/B: Probe 010 live-proven.
...
| Vince Pathfinder/Recovery V0.4 + V4.1.1 + V5 | sim | sim | sim para V1–V4.1.1, Work read-only e Termux A/B route failover | não | Probe 010: A+B READY → A selecionado; A WITHDRAWN → B selecionado; zero dispatch; PR #144/#146 | conectar seleção V5 a um único dispatch V4.1.1 com consumo durável; depois provar redundância multi-dispositivo; signer V3.2-live |
