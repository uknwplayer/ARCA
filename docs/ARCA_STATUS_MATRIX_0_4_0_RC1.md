...
| M5-F Parser Portal do schema Gate 046 | sim, fixture sintética | sim, parser fail-closed | não aplica bytes live | não | 11 campos exatos; hash Gate 046; `liveNormalizationAuthorized=false` | M5-G: admissão humana + normalização custodial offline |
