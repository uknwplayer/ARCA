...
| M5-N1 Descoberta PNCP de itens | sim, hash-bound + cost policy + custody-before-observation | sim | live 36050412298 executou 2 GETs e falhou em shape; captura não persistida | não | `ARCA_M5_N1_RESPONSE_SHAPE_INVALID`; candidato `8fbe4dc9...17c7b` não reutilizável; correção persiste antes de parse | CI/merge → novo preflight/live automático → prova durável de shape/itens |
