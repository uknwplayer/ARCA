...
| M5-N1 Descoberta PNCP de itens | sim, plano privado hash-bound | sim, testes sintéticos + workflow | não executado live | não | 2 alvos; `pagina=1&tamanhoPagina=50`; página cheia bloqueia M5-N2; sem fornecedor | CI/merge → preflight privado → candidato → autorização explícita dos 2 GETs |
