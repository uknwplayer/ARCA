...
| Portal da Transparência / captura M4b | sim, fixture + transporte + preview offline | sim | parcial: GET alcançado, auth rejeitada | não | PR #88/#95/#99; run live 35802699058 | autenticação válida, captura custodial e schema real |
