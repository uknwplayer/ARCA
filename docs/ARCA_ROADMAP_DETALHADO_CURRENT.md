...
- V4.1: **VERIFIER + TERMUX ONE-SHOT WORKER IMPLEMENTADOS / TESTADOS** — challenge 32-byte, Ed25519, pinning, replay protection e worker Android sem daemon; live probe #130 aguarda publicação da identidade pública local. Replit permanece opcional e pode ser reconciliado depois.
...
Aceite parcial alcançado para Vince V0.1–V0.4 + V4: discovery, ACK, execução, retorno, failover, recovery pós-crash e uma rota heterogênea GitHub↔Replit foram provados; V3.2 signed identity foi testado em CI. Próximo gate V4.1 é publicar/revisar a identidade pública do Termux e executar o probe #130. A reconciliação com Replit deixou de ser dependência para essa prova. Presença móvel/Edge permanece futura.
